(function($){
    $.fn.extend({ 
        MyPagination: function(options) {
            ...
            var lastPage = 1;
            var paginatePages;
console.log(objContent.children());
            ...
            init = function() {
                objContent.children().each(function(i){
                    ...
                    if ((height + this.clientHeight > options.height) && ((height + this.clientHeight) > options.height + 400)) {
                        ...
                        subPages = new Array();
                        height = 0;
						console.log(this.clientHeight+'zeroheight');
                    }
console.log(this.clientHeight+'clientheight');
