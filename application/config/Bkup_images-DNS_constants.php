...
define('source_base_path', '/var/www/html/samakalika/');
define('destination_base_path', '/var/www/html/samakalika/');
...
define('folder_name', 'smcpan');		
define('image_url', 'http://beta.samakalikamalayalam.com/');
define('no_articles', 'Please add articles to show');	
define('BASEURL', 'http://beta.samakalikamalayalam.com/');
define('HOMEURL', 'http://beta.samakalikamalayalam.com/');
