...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		{ ?>
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>smcpan/table_result_manager/table_result_table_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
			 <?php }?>
	...
	function delete_topic(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>smcpan/table_result_manager/table_result_delete/"+id;
		}
	}
</script>
<script>
	...
	$('#example').dataTable( 
{
    ...
    .append($('<td class="BackArrow"><a href="<?php  echo base_url(); ?>smcpan/table_result_manager" data-toggle="tooltip" title="Back to list"><i class="fa fa-reply fa-2x"></i></a></td>'));
		   }
		   else
		   {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>smcpan/table_result_manager/table_result_datatable",
			"type" : "POST",
			"data" : {
...
$("#flash_msg_id").slideDown(function() {
	...
	window.history.pushState('', '', "<?php echo base_url() ?>smcpan/table_result_manager/");
});
<?php } ?>
