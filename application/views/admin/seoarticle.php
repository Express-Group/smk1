...
<textarea readonly class="ckeditor" id="body_text" name="txtBodyText"><?php if(isset($get_article_details['ArticlePageContentHTML'])) echo $get_article_details['ArticlePageContentHTML']; echo set_value('txtBodyText'); ?></textarea>
 ...
 <span id="article_body_error"></span>
          ...
          <p>Preview</p>
			...
			<label>Caption :</label>
			<input readonly type="text" id="home_image_caption"   name="home_image_caption"  value="<?php echo htmlentities(@$get_article_details['homepageimageid']['temp_caption']);   ?>" class="margin-top-5 WidthFull" />
			<label>Image Alt :</label>
			<input readonly type="text" id="home_image_alt"  name="home_image_alt"  value="<?php echo htmlentities(@$get_article_details['homepageimageid']['temp_alt']);   ?>" class="margin-top-5 WidthFull">
        ...
        <p style="">Preview</p>
		   ...
		   <label>Caption :</label>
		   <input readonly type="text" value="<?php echo htmlentities(@$get_article_details['Sectionimageid']['temp_caption']);   ?>" name="section_image_caption"  id="section_image_caption"  class="margin-top-5 WidthFull" />
		   <label>Image Alt :</label>
		   <input readonly type="text" value="<?php echo htmlentities(@$get_article_details['Sectionimageid']['temp_alt']);   ?>" name="section_image_alt"    class="margin-top-5 WidthFull"  id="section_image_alt"    />
		   <label>Image Name :</label>
        ...
        <p style="">Preview</p>
		  ...
		  <label>Caption :</label>
		   <input readonly  type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_caption']);   ?>" name="article_image_caption"    class="margin-top-5 WidthFull" id="article_image_caption" />
		   <label>Image Alt :</label>
		   <input readonly type="text" value="<?php echo htmlentities(@$get_article_details['articleimageid']['temp_alt']);   ?>" name="article_image_alt"   class="margin-top-5 WidthFull"  id="article_image_alt" />
		   <label>Image Name :</label>
    ...
    <?php echo form_error('ddCity'); ?>
           ...
           <input disabled type="checkbox"  name="cbAllowComments" id="cbAllowComments"  <?php if(set_value("cbAllowComments") == 'on' || $page_name != 'edit_article' ||  (isset($get_article_details['Allowcomments']) && $get_article_details['Allowcomments'] == 1 ) ) echo  "checked"; ?> />
            <label for="cbAllowComments" class="margin-bottom-0">Allow Comments</label>
			  ...
			  <div class="padding-bottom-5">
           <input disabled type="checkbox"  name="cbAllowPagination" id="cbAllowPagination"  <?php if(set_value("cbAllowPagination") == 'on' || $page_name != 'edit_article' ||  (isset($get_article_details['allow_pagination']) && $get_article_details['allow_pagination'] == 1 ) ) echo  "checked"; ?> />
         ...
         <div class="article_attribute">
          ...
          <!--  <p>Social Meta Tag</p>
            ...
            <input disabled type="text" class="input_height box-shad1" name="txtCanonicalUrl"  value="<?php echo set_value('txtCanonicalUrl'); ?><?php if(isset($get_article_details['Canonicalurl'])) echo $get_article_details['Canonicalurl']; ?>" />
            </div>
            </div>
