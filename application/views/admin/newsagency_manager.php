...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		{ ?>
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>niecpan/newsagency_manager/newsagency_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
			 <?php }?>
	...
	function delete_newsagency(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>smcpan/newsagency_manager/newsagency_delete/"+id;
		}
	}
</script>
<script>
	...
	$('#example').dataTable( 
{
    ...
    $('#example').dataTable( {
      ...
      if ($(this).find('tbody tr').length<=1) {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>smcpan/newsagency_manager/newsagency_datatable",
			"type" : "POST",
			"data" : {
