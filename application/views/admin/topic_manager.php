...
<div class="Container">
	<div class="BodyWhiteBG">
		...
		{ ?>
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>smcpan/topic_manager/topic_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
			 <?php }?>
	...
	function delete_topic(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>smcpan/topic_manager/topic_delete/"+id;
		}
	}
</script>
<script>
	...
	$('#example').dataTable( 
{
    ...
    $('#example').dataTable( {
      ...
      if ($(this).find('tbody tr').length<=1) {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>smcpan/topic_manager/topic_datatable",
			"type" : "POST",
			"data" : {
