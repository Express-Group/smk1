 ...
 <?php echo form_error('ddState'); ?>
    ...
    <div id="tagform-full"  class="bs-example">
     ...
     <tr>
      ...
      <td  valign="top"><input disabled type="text" class="input_height box-shad1 FloatNone" name="txtCanonicalUrl"  value="<?php echo set_value('txtCanonicalUrl'); ?><?php if(isset($get_gallery_details['Canonicalurl'])) echo $get_gallery_details['Canonicalurl']; ?>" />
        ...
        <li style="display:none;" class=""><a id="section_href" href="#view2" >Multi Section Mapping</a></li>
          ...
          <section class="GalleryTabsContent">
            ...
            <div class="addFiles margin-top-0 add_files_new">
                  <a style="display:none;" href="#" data-remodal-target="modal1" id="BrowsePopup" class="fileUpload btn btn-primary">Browse</a>
				</div>
			</div>	
			...
			<table width="100%" cellspacing="0" class="display article_table dataTable no-footer gallerydatatable" id="sort" role="grid" aria-describedby="link_preview_table_info" style="width: 100%;"> 
				<thead id="link_preview_head" style="" >
					...
					<th style="display:none;" class="sorting_disabled" tabindex="0" aria-controls="link_preview_table" rowspan="1" colspan="1" style="width: 100px;" aria-label="Action: activate to sort column ascending">Action</th>
			...
			?>
				...
				$Physical_array = explode('.', $values->image_name);
				 ?>
						...
						<td><div align='center'><textarea readonly style='width:300px; text-align:center;'  name="image_caption" id="image_caption_id"  rel="<?php echo $Count; ?>" value="" ><?php echo str_replace('"',"'",$values->caption); ?></textarea></div></td>
						
						<td><div align='center'><textarea readonly style='width:300px; text-align:center;'  name="image_alt" id="image_alt_id"  rel="<?php echo $Count; ?>"  ><?php echo str_replace('"',"'",$values->alt_tag); ?></textarea></div></td>
