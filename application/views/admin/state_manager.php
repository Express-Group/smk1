	...
	<div class="BodyWhiteBG">
		<div class="BodyHeadBg Overflow clear">
			<div class="FloatLeft BreadCrumbsWrapper ">
             ...
             <p class="FloatRight SaveBackTop remoda1-bg"><a href="<?php echo base_url();?>smcpan/state_manager/state_form_view" type="button" class="btn-primary btn"><i class="fa fa-plus-circle"></i>Add New</a></p>
	...
	$('#example').dataTable( 
{
    ...
    $('#example').dataTable( {
		...
		"ajax": {
            "url": "<?php echo base_url(); ?>smcpan/state_manager/state_datatable",
			"type" : "POST",
			"data" : {
...
function delete_state(id)
		{
			...
			if(r==true){
			window.location.href="<?php echo base_url() ?>smcpan/state_manager/state_delete/"+id;
		}
	}
