...
<input type="text" placeholder="Search..." name="search_term" id="mobile_srch_term" value="<?php echo $search_term;?>"/> <a href="javascript:void(0);" id="mobile_search"><img data-src="<?php echo image_url; ?>images/FrontEnd/images/search-mob.png" src="<?php echo image_url; ?>images/FrontEnd/images/lazy.png" /></a></form></div>
...
<img data-src="'.image_url.$header_details['sitelogo'].'" src="'.image_url.'images/FrontEnd/images/lazy_logo.png" alt="site_logo"></a>';
?>
