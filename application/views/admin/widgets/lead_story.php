	...
	if(count($widget_instance_contents)>0)
	{
		...
		$dummy_image	= image_url. imagelibrary_image_path.'logo/nie_logo_600X390.jpg';			
				...
				$show_simple_tab .='<div class="item '.$add_active.'">
									<a  href="'.$live_article_url.'"  class="article_click" >'.$img_icon.'<img  src="'.$dummy_image.'"  data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a><h4 class="subtopic"><a  href="'.$live_article_url.'"  class="article_click" >'.$display_title.'</a></h4>';
