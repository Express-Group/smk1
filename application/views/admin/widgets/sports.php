						...
						if($i==1){
							$show_simple_tab .='<div class="sports1" id="sports_'.$widget_instance_id.'"><div class="cricket_top"></div>';
								...
								$show_simple_tab .= '<div class="item">
								 <div class="cricket">
								<a><h4  style="visibility:hidden;" class="topic">'.$section_name.'</h4></a><a  href="'.$live_article_url.'"  class="article_click" ><img src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"></a>';
