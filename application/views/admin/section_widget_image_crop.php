		...
		<div class="Overflow DropDownWrapper">
			<div class="form_list_new">
				...
				<div class="CroppingSize">
					<input type="checkbox" name="image_resize" id="image_resize_id" class="WidthAuto margin-right-10" value="image_600_390" <?php if($last_crop_image['imgtype600X390'] != 2) { echo "checked"; } ?> />
					...
					<input type="checkbox" name="image_resize" id="image_resize_id" class="WidthAuto" value="image_150_150"  <?php if($last_crop_image['imgtype100X65'] != 2) {  } ?>  />
...
<script src="<?php echo $script_url; ?>js/section_widget_image_crop.js" type="text/javascript"></script> 
<script type="text/javascript">
