...
<ul class="tabs margin-top-0 Article-Tab">
            ...
            <li class="" style="display:none;"><a id="section_href" href="#view2">Multi Section Mapping</a></li>
        </ul>
...
<div class="ArticleImageContainer1" id="audio_video_image_container" style="float:none; width:200px;<?php if(!isset($get_audio_video_details['image_details']['image_id'])) { echo "display:none;"; } else { echo "display:block;"; } ?>">
			...
			<label>Caption :</label>
			<input readonly type="text" id="audio_video_image_caption" name="audio_video_image_caption"  value="<?php echo htmlentities(@$get_audio_video_details['image_details']['caption']);   ?>" class="margin-top-5 WidthFull valid" aria-invalid="false">
			<label>Image Alt :</label>
			<input readonly type="text" id="audio_video_image_alt" name="audio_video_image_alt"  value="<?php echo htmlentities(@$get_audio_video_details['image_details']['alt_tag']);   ?>" class="margin-top-5 WidthFull valid" aria-invalid="false">
   ...
   <table class="FloatLeft metatitle1">
    ...
    <div id="charNum2" class="charNum"><?php if(isset($get_audio_video_details['MetaDescription'])) echo 200 - mb_strlen($get_audio_video_details['MetaDescription']); else echo "200"?></div>
     ...
     <tr>
      ...
      <td><input readonly type="text" class="box-shad"  maxlength="252" name="txtCanonicalUrl" id="txtCanonicalUrl" value="<?php if(isset($get_audio_video_details['Canonicalurl'])) echo $get_audio_video_details['Canonicalurl'];  echo set_value('txtCanonicalUrl');?>"  />
