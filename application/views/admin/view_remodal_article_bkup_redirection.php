...
<link rel="<?php if($content_type_id==1){ echo 'amphtml'; }else{ echo 'canonical'; } ?>" href="<?php echo $Canonicalurl;?>" />
...
<?php if($content_id=='34265'){ ?>
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<script>
 (adsbygoogle = window.adsbygoogle || []).push({google_ad_client: "ca-pub-4861350176551585",   enable_page_level_ads: true});
</script>
<?php } ?>
<?php if($content_id!='34265'){ ?>
...
<script type='text/javascript'>
  googletag.cmd.push(function() {
	var mapping = googletag.sizeMapping().addSize([728,90], [728, 90]).addSize([0, 0], [320, 100]).build();
	googletag.defineSlot('/3167926/skm_dktp_art_728x90', [728, 90], 'div-gpt-ad-1527235695498-0').defineSizeMapping(mapping).addService(googletag.pubads());
    googletag.pubads().enableSingleRequest();
    googletag.enableServices();
  });
  googletag.cmd.push(function() {
    googletag.defineSlot('/3167926/skm_dktp_art_300x250_1', [300, 250], 'div-gpt-ad-1527235483483-0').addService(googletag.pubads());
    googletag.defineSlot('/3167926/skm_dktp_art_300x250_2', [300, 250], 'div-gpt-ad-1527235483483-1').addService(googletag.pubads());
    googletag.defineSlot('/3167926/skm_dktp_art_300x250_3', [300, 250], 'div-gpt-ad-1527235483483-2').addService(googletag.pubads());
    googletag.defineSlot('/3167926/skm_dktp_art_300x250_4', [300, 250], 'div-gpt-ad-1527235483483-3').addService(googletag.pubads());
    googletag.defineSlot('/3167926/skm_dktp_art_300x250_5', [300, 250], 'div-gpt-ad-1527235483483-4').addService(googletag.pubads());
    googletag.defineSlot('/3167926/skm_art_1x1', [1, 1], 'div-gpt-ad-1527235483483-5').addService(googletag.pubads());
    googletag.defineSlot('/3167926/skm_art_2_1x1', [1, 1], 'div-gpt-ad-1527235483483-6').addService(googletag.pubads());
    googletag.pubads().enableSingleRequest();
    googletag.enableServices();
  });
</script>
<?php } ?>
<script type="text/javascript" src="//sdk.adspruce.com/1/adspruce.js?pid=3618&sid=4" defer></script>
<script> window._izq = window._izq || []; window._izq.push(["init"]); </script>
<script src="https://cdn.izooto.com/scripts/9df16b05ffdb83b455b1dffbda0a8270dd1cc15b.js"></script>
</head>
<?php
