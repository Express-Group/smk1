	...
	public function GetDynamicTables(){
		...
		if($Data=='NO ROWS'){
			...
			foreach($Data as $Datavalue):
				...
				$Template .='<div class="col-md-2 dynamic-table-width">';
				$Template .='<table class="table table-bordered">';
				$Template .='<tr class="table-header-wrapper"><td colspan="2" style="border-color:#000;font-weight:bold;">'.$TableName.'</td><td colspan="2" class="table-header-wrapper-second" style="border-color:#000;" >'.$Total.'</td></tr>';
