...
class section_widget_articles extends CI_Controller
{
	...
	public function index()
	{
		...
		if($get_widget_type == "jumbo_widget_articles")
		{
			...
			$data['breadcrumb_url']   = 'smcpan/jumbo_widget_articles';
		...
		else if($get_widget_type == "editor_pick_articles")
		{
			...
			$data['breadcrumb_url']   = 'smcpan/editor_pick_articles';
		...
		else if($get_widget_type == "trending_now_articles")
		{
			...
			$data['breadcrumb_url']   = 'smcpan/trending_now_articles';
		...
		else if($get_widget_type == "related_articles")
		{
			...
			$data['breadcrumb_url']   = 'smcpan/related_articles';
		...
		{
			redirect('smcpan/common/access_permission/'.$access_url.'');
		}
	}
