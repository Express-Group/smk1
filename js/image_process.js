						 ...
						 'image1_type' 			: data[key].image1_type,
						  ...
						  'image4_type' 		: data[key].image4_type
						   ...
						   if(display_order%2 != 0)
							...
							var	Content = "<tr "+Class+" id='gallery_image"+data[key].image_id+"'><td><img class='gallery_dataimage' src='"+data[key].image+"'/></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_caption' id='image_caption_id' rel='"+data[key].image_id+"' value='"+data[key].caption+ "' /></div></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_alt' id='image_alt_id' rel='"+data[key].image_id+"' value='"+data[key].alt_tag+"' /></div></td><td><div align='center'><input type='textbox' style='width:100%; text-align:center;' physical_extension='"+data[key].physical_extension+"'   rel='"+data[key].image_id+"'    name='physical_name' id='physical_name' rel='"+data[key].image_id+"' value='"+physical_name+"' /></div><span class='error' id='error_"+data[key].image_id+"'></span></td><td><div class='article_table_delete'>  <a  id='edit_image' rel='"+data[key].image_id+"' href='javascript:void(0);' class='button tick tooltip-2' data-toggle='tooltip'   title='Edit' data-original-title='Edit'><i class='fa fa-pencil'></i></a><a class='button cross' href='javascript:void(0)' data-toggle='tooltip'   title='Delete' data-original-title='Delete' id='deletetempimage' rel='"+data[key].image_id+"' ><i class='fa fa-trash-o'></i></a></div></td></tr>";
			...
			success: function(data)	{  
					...
					if(SelectImage[data.image_id] == undefined)  
					{
						 ...
						 if(display_order%2 != 0)
							...
							var	Content = "<tr "+Class+" id='gallery_image"+data.image_id+"'><td><img class='gallery_dataimage' src='"+data.image+"'/></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_caption' id='image_caption_id' rel='"+data.image_id+"' value='"+data.caption+ "' /></div></td><td><div align='center'><input type='textbox' style='width:200px; text-align:center;'  name='image_alt' id='image_alt_id' rel='"+data.image_id+"' value='"+data.alt_tag+"' /></div></td><td><div align='center'><input type='textbox' style='width:100%; text-align:center;'  name='physical_name' id='physical_name' physical_extension='"+data.physical_extension+"'   rel='"+data.image_id+"'  value='"+physical_name+"' /></div><span class='error' id='error_"+data.image_id+"'></span></td><td><div class='article_table_delete'>  <a  id='edit_image' rel='"+data.image_id+"' href='javascript:void(0);' class='button tick tooltip-2' data-toggle='tooltip'   title='Edit' data-original-title='Edit'><i class='fa fa-pencil'></i></a><a class='button cross' href='javascript:void(0)' data-toggle='tooltip'   title='Delete' data-original-title='Delete' id='deletetempimage' rel='"+data.image_id+"' ><i class='fa fa-trash-o'></i></a></div></td></tr>";
